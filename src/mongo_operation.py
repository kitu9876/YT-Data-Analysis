...
client= pymongo.MongoClient("mongodb+srv://kiran:<password>@cluster0.busb95b.mongodb.net/?retryWrites=true&w=majority")
...
class MongoOperation:
    def __init__(self, username="YOUR_USERNAME", password="YOUR_PASSWORD"):
        try:
            ...
            self.url = f"mongodb+srv://{username}:{password}@cluster0.busb95b.mongodb.net/?retryWrites=true&w=majority"
